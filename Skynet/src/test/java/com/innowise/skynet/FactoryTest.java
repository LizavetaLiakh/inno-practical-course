...
public class FactoryTest {
    ...
    void testProduceParts() {
        ...
        assertEquals(10, factory.getParts().size(), "There should be 10 robot parts in the factory.");
    }
    ...
    void testStealPartsReducing() {
        ...
        synchronized (factory) {
            ...
            int beforeStealing = factory.getParts().size();
            factory.stealParts(5);
            int afterStealing = factory.getParts().size();
